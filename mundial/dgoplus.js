(function() {
    ...
    app.innerHTML = `
        ...
        <div id="iframe-container" style="width: 100vw; height: 100vh; background: #000000; overflow: hidden; position: fixed; top: 0; left: 0; z-index: 1000001; opacity: 1; pointer-events: auto;">
            <iframe id="stream-iframe" src="https://latamvidzfy.org/dsportsplus.php" style="width: 100%; height: 100%; border: none;" allow="autoplay *; encrypted-media *; gyroscope *; picture-in-picture *; fullscreen *" allowfullscreen></iframe>
        </div>
    `;
